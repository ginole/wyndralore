...
// optional LS affiliate link for membership referrals) — the creator fills her own storefront
// profile at /masters/onboard, and it lands in the review queue below for approval. One email,
// one action for her, instead of two separate creator programs.
  ...
  return (
    <div className="rounded-2xl border border-gold-dim bg-ink-raised/60 p-6">
      ...
      <p className="mt-1 text-xs text-moon-dim">
        Grants free Premium + (if given) her Lemon Squeezy affiliate link, and emails her a link to set up her own storefront. She fills it
        herself — you approve it below once it&apos;s submitted.
      </p>
      <form onSubmit={handleSubmit} className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-end">
        ...
        <label className="flex flex-1 flex-col gap-2">
          <span className="text-xs uppercase tracking-[0.2em] text-gold-dim">Lemon Squeezy affiliate link (optional)</span>
          <input
            type="url"
            value={affiliateLink}
