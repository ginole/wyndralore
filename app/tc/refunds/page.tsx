    ...
    <section className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-8 flex flex-col gap-6 text-sm leading-relaxed text-moon-dim">
        ...
        <div>
          ...
          <p className="mt-2">
            進階權限與 AI 解讀屬於數位內容。解讀一經產生，內容即為你的占卜量身而成、無法收回，因此自該時點起原則上不予退款。完成購買即表示你明確要求立即開始交付，並承認一旦交付已經開始，你即因此喪失任何法定的猶豫期或撤回權——包括（在適用情況下）歐盟／英國消費者法下的 14 天猶豫期。特殊情況請來信 hello@wyndralore.com 說明，我們會個別評估。此外，信用卡付款由 Whop 以登記商戶身分處理，Whop 自身的退款規則與本政策併行適用——兩者若有出入，以收款平台的實際規則為準。
          </p>
        </div>
